...
The Client agrees to provide The Webmaster full ftp and secure shell access to the hosting server. The Client understands that some website changes may require a change in hosting services which is not covered by this agreement.
