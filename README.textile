...
The Client is contracting The Webmaster as an independent contractor for website design and development maintenance. This includes fixing errors, adding new pages, editing existing pages, and simple modifications to scripts, templates, applications, and databases.
...
All service plans begin on the 1st of each month. All website maintenance requests have a minimum charge of ½ hour with all additional time charged to the nearest ½ hour. The Client is charged for services rendered as stated herein. A log of time spent will be provided upon request.
...
Please select your desired service plan. An X next to a plan indicates that plan is selected for this Agreement.
